...
const MobileControls: React.FC<MobileControlsProps> = ({ 
  ...
  return (
    <>
      {/* Map Navigation Button - Moved outside main container */}
      {currentMap === 'music' && (
        <button
          className="fixed top-4 right-4 bg-black/50 text-white px-4 py-2 rounded-none font-bytebounce z-[100000]"
          onClick={() => {
